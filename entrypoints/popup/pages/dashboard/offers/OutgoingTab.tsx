        ...
        <div key={item.contractId} className="rounded-xl bg-secondary p-3 space-y-2">
          ...
          {activeContract === item.contractId && preparedData ? (
            <div className="space-y-2 pt-2 border-t border-border">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-1 rounded-lg bg-destructive/20 text-destructive py-2 text-xs font-medium disabled:opacity-40"
                >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-1 rounded-lg bg-destructive/20 text-destructive py-2 text-xs font-medium"
            >
