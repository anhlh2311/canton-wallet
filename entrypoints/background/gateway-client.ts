/**
 * Wallet Gateway JSON-RPC client for Canton Wallet extension.
 *
...
export async function ensureGatewaySession(): Promise<void> {
  ...
  console.log(`[Canton Wallet Gateway] Establishing session for network: ${currentGatewayAuth.networkId}`);
  await gatewayUserRpcRaw('addSession', { networkId: currentGatewayAuth.networkId });
  sessionEstablished = true;
  console.log('[Canton Wallet Gateway] Session established');
}
