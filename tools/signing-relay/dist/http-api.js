 ...
 */
httpRouter.post('/signTransaction', async (req, res) => {
    try {
        const body = req.body;
        if (!body.txHash) {
 ...
 */
httpRouter.post('/getTransaction', (req, res) => {
    const body = req.body;
    if (!body.txId) {
 ...
 */
httpRouter.post('/getTransactions', (req, res) => {
    const body = req.body;
    const transactions = [];
    if (body.txIds) {
 ...
 */
httpRouter.post('/getKeys', (_req, res) => {
 ...
 */
httpRouter.post('/createKey', (req, res) => {
    const body = req.body;
